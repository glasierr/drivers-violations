package vlasenko.violations.consumer.config;
...
import vlasenko.violations.consumer.config.properties.DatabaseProperties;
...
public class DatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan("vlasenko.violations.consumer");
